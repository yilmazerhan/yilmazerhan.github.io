...
def upgrade() -> None:
    op.execute("CREATE TYPE announcement_type AS ENUM ('info', 'warning', 'error', 'success')")
    op.execute("CREATE TYPE announcement_target_type AS ENUM ('all', 'specific_teams', 'specific_users')")
